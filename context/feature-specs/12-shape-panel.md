Add a bottom shape tool panel so users can drag shapes onto the canvas and create new nodes.

## Implementation

1. Add a floating pill-shaped toolbar at the bottom-center of the canvas.

2. Add draggable icon for these shapes:
   - rectangle
   - diamond
   - circle
   - pill
...
5. On drop:
   - read the dragged shaped payload
