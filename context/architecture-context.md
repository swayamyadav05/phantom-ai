...
- `src/trigger` — Long-running background jobs: AI design generation and spec generation.
- `src/lib` — Shared infrastructure: Prisma client, access control helpers, and utilities.
- `src/components` — UI composition: canvas surfaces, sidebars, dialogs, and interactive elements.
